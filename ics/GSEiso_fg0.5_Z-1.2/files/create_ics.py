...
masses = np.array([0., 0., 0., 0., 0., 0.])
for i in range(6):
    npart[i]  = sn_GSE.NumPart_Total[i]
...
# Load into ics
ics.part0.pos[:] = pos_GSE_part0
#ics.part0.mass[:] = np.concatenate((sn_MW.part0.mass, sn_GSE.part0.mass)) 
ics.part0.vel[:] = vel_GSE_part0
#ics.part0.id[:]  = sn_gas.part0.id
ics.part0.u[:]   = sn_GSE.part0.u

ics.part1.pos[:] = pos_GSE_part1
ics.part1.vel[:] = vel_GSE_part1
#ics.part1.id[:]  = sn.part1.id

ics.part2.pos[:] = pos_GSE_part2
ics.part2.vel[:] = vel_GSE_part2
...
ics.part0.GFM_Metallicity[:] = metallicity_GSE
