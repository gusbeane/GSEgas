...
pos0, vel0 = separate(np.array([[0., 0., 0.]]), np.array([[0., 0., 0.]]), Rstart, Vvir, e, pro)
pos0, vel0 = rotate(pos0, vel0, angle)

vel0_dir = vel0[0] / np.linalg.norm(vel0[0])

vel_GSE_part0 -= kick * vel0_dir
