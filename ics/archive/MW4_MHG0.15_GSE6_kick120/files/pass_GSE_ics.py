...
ics.part0.mass[:] = np.full(sn_GSE.NumPart_Total[0], sn_GSE.MassTable[0])
...
metal_frac_arr_GSE_disk = np.full((sn_GSE.NumPart_Total[0], 10), metal_fractions_GSE_disk)

#metal_fractions = np.concatenate((metal_frac_arr_GSE_disk, metal_frac_arr_GSE_halo))
metal_fractions = metal_frac_arr_GSE_disk

ics.part0.GFM_Metals[:] = metal_fractions 

metallicity_GSE_disk = np.full(sn_GSE.NumPart_Total[0], zsolar_GSE_disk * GFM_SOLAR_METALLICITY)
#metallicity = np.concatenate((metallicity_GSE_disk, metallicity_GSE_halo))
metallicity = metallicity_GSE_disk
