...
ics = arepo.ICs('MW.hdf5', npart, masses=masses)
...
metallicity_MW_disk = np.full(N_GAS, zsolar_MW_disk)
metallicity_MW_halo = np.full(sn_MW.NumPart_Total[0] - N_GAS, zsolar_MW_halo)
