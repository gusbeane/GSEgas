...
if sn_GSE.NumPart_Total[0] > 0:
    ...
    in_GSE = np.full(sn_MW.NumPart_Total[0], False)
...
if Npart0_GSE > 0:
    ...
    ics.part0.vel[:] = sn_MW.part0.vel[key_MW]
...
Npart1_MW = sn_MW.NumPart_Total[1]
Npart1_GSE = sn_GSE.NumPart_Total[1]
print('part1 GSE ID: ', ics.part1.id[Npart1_MW], ics.part1.id[Npart1_MW + Npart1_GSE-1])
