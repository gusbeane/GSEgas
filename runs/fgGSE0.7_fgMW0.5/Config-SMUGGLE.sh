...
#TRACER_MC_NUM_FLUID_QUANTITIES=8   # number of fluid quantities to be stored for MC tracers - must match the number in TRACER_MC_STORE_WHAT
#TRACER_MC_STORE_WHAT=1+2+4+8+16+32+256+1024          # bit mask for quantities to store (see allvars.h for bitmask)
