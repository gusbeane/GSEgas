...
#NSOFTTYPES=4
INDIVIDUAL_GRAVITY_SOFTENING=4+8
PLACEHIGHRESREGION=2
ENLARGEREGION=1.1
GRIDBOOST=1
PM_ZOOM_OPTIMIZED

#L35n2160TNG_STOP_AFTER_WRITING_SNAPSHOT # inserted for L35n2160TNG_DM after run 4060928
#USE_DIRECT_IO_FOR_RESTARTS # enabled for L35n2160TNG_DM after run 4060928
...
#SIDM REMOVES #HIERARCHICAL_GRAVITY             # use hierarchical splitting of the time integration of the gravity
#SIDM REMOVES ##CELL_CENTER_GRAVITY              # uses geometric centers to calculate gravity of cells, only possible with HIERARCHICAL_GRAVITY
#SIDM REMOVES #ALLOW_DIRECT_SUMMATION
#SIDM REMOVES #DIRECT_SUMMATION_THRESHOLD=9600 # 9600 for L35n2160TNG
...
#--------------------------------------- TreePM Options
#PMGRID=6144		#4096 for L75n1820TNG, 6144 for L35n2160TNG
