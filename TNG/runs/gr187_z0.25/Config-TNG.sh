...
#TRACER_MC_NUM_FLUID_QUANTITIES=1                      # number of fluid quantities to be stored for MC tracers - must match the value gien to TRACER_MC_STORE_WHAT
#TRACER_MC_STORE_WHAT=256         # bit mask for quantities to store (see allvars.h for bitmask)
